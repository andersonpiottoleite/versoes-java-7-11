package br.com.versaooito.time;
...
public class DataNoJava8 {
	...
	public static void main(String[] args) {
		// problema ao lhe dar com datas ans versões anteriores
	...
	private static void localDate() {
		...
		LocalDate outraDataParametrizada = LocalDate.parse("2017-02-20");
		...
		boolean notBefore = LocalDate.parse("2016-06-12").isBefore(LocalDate.parse("2016-06-13"));
